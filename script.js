...
const I18N = {
  es: {
    'nav.work': 'Inicio', 'nav.about': 'Sobre mí', 'nav.exp': 'Experiencia', 'nav.projects': 'Proyectos', 'nav.certs': 'Certificados', 'nav.contact': 'Contacto',
    ...
    'exp.rocioRole': 'Ingeniero de Sistemas', 'exp.rocioMeta': 'ene 2025 – may 2025 · 5 meses · Cali, Valle del Cauca · Híbrido',
    'exp.rocio1': 'Rediseñé la estructura operativa (pedidos, envíos y atención al cliente) mediante <b>ingeniería inversa y modelado de negocios (MER, UML)</b>, identificando fallas y áreas de mejora.',
    'exp.rocio2': 'Capacité al CEO en <b>herramientas de IA</b> para automatizar tareas, analizar datos y optimizar la productividad, con asesoría constante en ventas.',
    'exp.empRole': 'Chatbot Specialist', 'exp.empMeta': 'abr 2025 – may 2025 · 2 meses · Colombia · Remoto',
    'exp.empIntro': 'Traducción de la lógica de negocio a <b>sistemas conversacionales productivos</b> para toma de pedidos y gestión de atención al cliente.',
    'exp.emp1': 'Diseño de estados conversacionales y manejo de excepciones.',
    'exp.emp2': '<b>Integración REST</b> con sistema de inventario/CRM: validación en tiempo real de stock, precios y confirmación de despacho.',
    'exp.emp3': 'Optimización operativa: automatización de consultas repetitivas, reducción de tiempos de respuesta y <b>escalabilidad sin aumentar el headcount</b>.',
    'projects.title': 'Proyectos', 'projects.featuredTag': '⭐ Destacado',
    'projects.medTitle': 'Gestión de Citas Médicas — SGCM', 'projects.medDesc': 'Plataforma para instituciones de salud: sedes, especialidades, pacientes, médicos, agendamiento e historia clínica. Mi rol fue <b>backend</b>: lógica de servidor, integración con Oracle vía Django ORM, seguridad y generación de reportes PDF. Trabajo en equipo con Frank y Milton.',
  ...
  en: {
    'nav.work': 'Home', 'nav.about': 'About', 'nav.exp': 'Experience', 'nav.projects': 'Projects', 'nav.certs': 'Certificates', 'nav.contact': 'Contact',
    ...
    'exp.rocioRole': 'Systems Engineer', 'exp.rocioMeta': 'Jan 2025 – May 2025 · 5 months · Cali, Valle del Cauca · Hybrid',
    'exp.rocio1': 'Redesigned the operational structure (orders, shipping and customer service) through <b>reverse engineering and business modeling (ER, UML)</b>, identifying failures and areas for improvement.',
    'exp.rocio2': 'Trained the CEO on <b>AI tools</b> to automate tasks, analyze data and boost productivity, with ongoing sales advisory.',
    'exp.empRole': 'Chatbot Specialist', 'exp.empMeta': 'Apr 2025 – May 2025 · 2 months · Colombia · Remote',
    'exp.empIntro': 'Translated business logic into <b>production-ready conversational systems</b> for order taking and customer-service management.',
    'exp.emp1': 'Design of conversational states and exception handling.',
    'exp.emp2': '<b>REST integration</b> with inventory/CRM systems: real-time validation of stock, prices and dispatch confirmation.',
    'exp.emp3': 'Operational optimization: automation of repetitive queries, reduced response times and <b>scalability without increasing headcount</b>.',
    'projects.title': 'Projects', 'projects.featuredTag': '⭐ Featured',
    'projects.medTitle': 'Medical Appointments Management — SGCM', 'projects.medDesc': 'Platform for healthcare institutions: locations, specialties, patients, doctors, scheduling and clinical history. My role was <b>backend</b>: server-side logic, Oracle integration via Django ORM, security and PDF report generation. Team work with Frank and Milton.',
